...
namespace CsvImportSite.Tests.ControllerTests
{
	public class HomeControllerTests
	{
		...
		private TempDataDictionary _tempData { get; set; }
		...
		[Fact]
		public void HomeController_EditPost_ReturnsRedirectToAction()
		{
			//Arrange
			...
			resultError.TempData.Should().ContainValue("This is exception");
		}
		[Fact]
