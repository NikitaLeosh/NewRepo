...
namespace CsvImportSite.Controllers
{
	public class HomeController : Controller
	{
		...
		//POST method to parse the csv file to the records and return index page right away
		[HttpPost]
		...
		public async Task<IActionResult> Index(IndexViewModel indexViewModel)
		{
			...
			if (indexViewModel.CsvFile != null)
			{
				...
				{
					// Catching the DB conflict exception by its number
